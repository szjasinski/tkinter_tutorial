...
def zip_lookup():
    ...
    try:
        api_request = requests.get(
            "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zip.get() + "&distance=500&API_KEY=556B5ECC-D0ED-460A-A061-937121CD0C44")
