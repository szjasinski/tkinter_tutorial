...
# hide all frames
def hide_all_frames():
    # loop thru all the children in each frame and destroy them
...
def edit_cut():
    ...
    dummy_btn = Button(edit_cut_frame, text="fake!").pack(pady=10)
    child_label = Label(edit_cut_frame, text=edit_cut_frame.winfo_children()[0])
